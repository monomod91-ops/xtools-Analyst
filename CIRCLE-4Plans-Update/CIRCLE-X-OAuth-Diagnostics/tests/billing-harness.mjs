...
export function billingPool() {
  ...
  raw.exec(readFileSync(new URL('../netlify/database/migrations/20260911000100_circle-multiple-plans/migration.sql',import.meta.url),'utf8').replaceAll('ADD COLUMN IF NOT EXISTS','ADD COLUMN'));
