...
test('no invoice, missing verified identity or forged role cannot obtain access',async()=>{
  ...
  for(const fake of [null,{...user,email:''},{id:user.id,roles:['paid'],user_metadata:{paid:true}}])
