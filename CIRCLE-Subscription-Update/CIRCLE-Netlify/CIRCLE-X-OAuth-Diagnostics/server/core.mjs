...
export async function handle(req,env){
 ...
 }catch(e){if(path==='oauth/callback')return oauthFailureResponse(e,c.origin,oauthStage);return json({error:e instanceof ServiceError||e instanceof BillingError?e.message:'連携サービスで問題が起きました。時間をおいて再試行してください。',code:e.code||'server_error',retryAt:e.retryAt||null},e.status||500)}
}
